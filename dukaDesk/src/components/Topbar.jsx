...
export default function Topbar() {
  ...
  return (
    <div style={{ height: isMobile ? 56 : 64, background: "#fff", borderBottom: "1px solid #E5E7EB", display: "flex", alignItems: "center", padding: `0 ${isMobile ? 16 : 32}px`, gap: isMobile ? 8 : 16, flexShrink: 0 }}>
      <h1 style={{ fontFamily: "'Sora',sans-serif", fontWeight: 700, fontSize: isMobile ? 16 : 20, color: NAVY, margin: 0, flex: 1, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>Good morning, Ada 👋</h1>
      {!isMobile && (
      ...
      <div style={{ width: isMobile ? 32 : 36, height: isMobile ? 32 : 36, background: AMBER, borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 700, color: NAVY, cursor: "pointer", fontFamily: "'Sora',sans-serif", fontSize: isMobile ? 12 : 14, flexShrink: 0 }}>A</div>
    </div>
  );
}
